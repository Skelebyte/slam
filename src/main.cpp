...
//     ((f32)Input::GetAxis(horizontal)); velocity +=
//     player.transform.Forward() *
//     -((f32)Input::GetAxis(vertical));

//     player.transform.position +=
//         Mathf::Normalized(velocity) * 5.0f * Time::DeltaTime();

//     r = Mathf::Wrap(r + Mathf::Random(100) / 100.0f * Time::DeltaTime(),
//     0.0f,
//                     1.0f);
//     g = Mathf::Wrap(g + Mathf::Random(100) / 100.0f * Time::DeltaTime(),
//     0.0f,
//                     1.0f);
//     b = Mathf::Wrap(b + Mathf::Random(100) / 100.0f * Time::DeltaTime(),
//     0.0f,
//                     1.0f);
...
//     ImGui::DragFloat("Culling Angle", &cam.cullingAngle, 0.05f,
//     -1.0f, 1.0f); ImGui::DragFloat("Culling Distance",
//     &cam.cullingDistance, 0.5f, 0.0f,
//                      100.0f);
